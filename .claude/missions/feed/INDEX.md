...
|---|---------|-------------|------|--------|
| 1 | Auth & Session | feed-auth-debugger | P0 | authored |
| 2 | Profiles & Settings | feed-supabase-validator | P1 | authored |
| 3 | AI Chat | feed-chat-expert | P0 | authored |
| 4 | Resource Map & Geo | feed-map-debugger | P0 | authored |
| 5 | Community Feed | feed-realtime-monitor | P0 | authored |
| 6 | Messages | feed-messages-expert | P1 | authored |
| 7 | Events & Check-ins | feed-programs-expert | P1 | authored |
| 8 | Petitions | feed-data-flow-analyzer | P1 | authored |
| 9 | Documents & Vault | feed-documents-expert + feed-vault-expert | P0 | authored |
| 10 | Forms & Applications | feed-forms-expert | P0 | authored |
| 11 | Programs | feed-programs-expert | P1 | authored |
| 12 | Safety Alerts | feed-map-debugger | P1 | authored |
| 13 | Volunteer Resources | feed-volunteer-expert | P1 | authored |
| 14 | Saved Resources | feed-resources-expert | P2 | authored |
| 15 | Reviews & Harmony | feed-resources-expert | P2 | authored |
| 16 | Notifications | feed-realtime-monitor | P2 | authored |
| 17 | Content Moderation | feed-supabase-validator | P1 | authored |
| 18 | Dashboard/Analytics | feed-data-flow-analyzer | P1 | authored |
| 19 | Admin Resource Discovery | feed-edge-functions-expert + feed-resources-expert | P0 | authored |
| 20 | Federation | feed-federation-expert | P2 | authored |
| 21 | External Sync 211/HUD/IMLS/SNAP | feed-resources-expert | P2 | authored |
